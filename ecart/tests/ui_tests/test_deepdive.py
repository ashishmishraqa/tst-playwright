...
class TestNetworkCalls(BaseTest):
    ...
    def intercept_request(route):
        route.continue_(
            url="https://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=68d3527c1233"
        )
    ...
    def test_network(page: Page):
        ...
        page.route(
            ...
            handler=TestNetworkCalls.intercept_response,
        )
        # Login
    ...
    def test_network_2(page: Page):
        ...
        page.route(
            ...
            handler=TestNetworkCalls.intercept_request,
        )
        # Login
        page.locator("#userEmail").fill("demo@playwright.com")
        page.locator("#userPassword").fill("Qwe@1234")
